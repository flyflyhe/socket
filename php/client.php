...
<input type="text" id="uri" value="ws://localhost:4000" style="width: 200px;">
<input type="button" id="connect" value="Connect"><input type="button" id="disconnect" value="Disconnect" disabled="disabled">
<form >
